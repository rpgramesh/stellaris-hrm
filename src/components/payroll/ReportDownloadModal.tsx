...
interface ReportDownloadModalProps {
  ...
  reportData: any;
  onDownload: (format: 'xlsx' | 'pdf') => void | Promise<void>;
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        The <strong>{reportTitle}</strong> has been processed and is ready for download.
                ...
                <div className="mt-5 sm:mt-6 grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="inline-flex w-full justify-center items-center gap-2 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
